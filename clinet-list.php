					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="clinet-addf.php">Add Clinet</a>&nbsp;<i class="fa fa-plus"></i>
								</li>
										...
										while($line=$obj->fetchNextObject($sql)){?>
											<tr class="odd">
												...
												<td>
												  ...
												  <td>
													<a href="clinet-addf.php?id=<?php echo $line->id;?>" class="tblEditBtn">
														<i class="fa fa-pencil"></i>
													</a>
													<a href="clinet-del.php?id=<?php echo $line->id;?>" title="deletel" class="tblDelBtn">
