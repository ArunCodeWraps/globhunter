...
{	
	$materials=$obj->escapestring($_POST['materials']);

	$obj->query("update $tbl_setting set materials='$materials' where id=1",-1); //die;
	$_SESSION['sess_msg']='materials updated sucessfully';   
	header("location:materials-addf.php");
	exit();
}      	      
								...
								<div class="card-body row">									
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<textarea name="materials" id="formsummernote" class="mdl-textfield__input" required><?php echo $result->materials; ?></textarea>
										</div>
									</div>
