...
if( $moved ) {
  ...
  echo "Not uploaded because of error #".$_FILES["file"]["error"];
   ...
   $obj->query("update $tbl_users set name='$name',email='$email',mobile='$mobile',password='$password',image='$fileNameNew' where id='".$_SESSION['sess_admin_id']."'",-1);//die;
...
<!-- 								<li><a class="parent-item" href="Profile-list.php">Recruiter List</a>&nbsp;<i class="fa fa-list"></i> -->
								</li>
							</ol>
						</div>
					</div>
							...
							<input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>" />	
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="email" id="email" name="email" value="<?php echo $result->email ?>" readonly>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text"
											 id="password" name="password" value="<?php echo $result->password ?>" readonly>
